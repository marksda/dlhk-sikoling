import { Breadcrumb, DefaultEffects, DocumentCard, DocumentCardLogo, DocumentCardTitle, IBreadcrumbItem, IDocumentCardLogoProps, IDocumentCardStyles, IStackStyles, IStackTokens, mergeStyles, Stack } from "@fluentui/react";
...
const conversationTileClass = mergeStyles({ height: 48 });
                            ...
                            <Stack horizontal tokens={stackTokens}>
                                ...
                                >
                                    ...
                                    <div className={conversationTileClass}>
                                        <DocumentCardTitle title="Daftar perusahaan" />
                                    </div>
                                </DocumentCard>
                                <DocumentCard
                                ...
                                >
                                    ...
                                    <div className={conversationTileClass}>
                                        <DocumentCardTitle title="Daftar permohonan" />
                                    </div>
                                </DocumentCard>
                            </Stack>
                        </Stack.Item>
