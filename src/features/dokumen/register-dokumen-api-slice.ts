        ...
        return {
            ...
            getAllRegisterDokumen: builder.query<daftarRegisterDokumen, void>({
                ...
                providesTags: (result) => 
                    ...
                    [
                        ...result.map(
                            ({ perusahaan: registerPerusahaan, dokumen }) => ({ type: 'RegisterDokumen' as const, id: `${registerPerusahaan?.id}*${dokumen?.id}` })
                        ),
            ...
            getRegisterDokumenByPage: builder.query<daftarRegisterDokumen, {page: number; pageSize: number}>({
                ...
                providesTags: (result) => 
                    ...
                    [
                        ...result.map(
                            ({ perusahaan: registerPerusahaan, dokumen }) => ({ type: 'RegisterDokumenPage' as const, id: `${registerPerusahaan?.id}*${dokumen?.id}` })
                        ),
            ...
            getRegisterDokumenByPerusahaan: builder.query<daftarRegisterDokumen, string>({
                ...
                providesTags: (result) => 
                    ...
                    [
                        ...result.map(
                            ({ perusahaan: registerPerusahaan, dokumen }) => ({ type: 'RegisterDokumenPerusahaan' as const, id: `${registerPerusahaan?.id}*${dokumen?.id}` })
                        ),
            ...
            getRegisterDokumenByPerusahaanAndPage: builder.query<daftarRegisterDokumen, {namaPerusahaan: string; page: number; pageSize: number}>({
                ...
                providesTags: (result) => 
                    ...
                    [
                        ...result.map(
                            ({ perusahaan: registerPerusahaan, dokumen }) => ({ type: 'RegisterDokumenPerusahaanPage' as const, id: `${registerPerusahaan?.id}*${dokumen?.id}` })
                        ),
            ...
            getRegisterDokumenByIdPerusahaan: builder.query<daftarRegisterDokumen, string>({
                ...
                providesTags: (result) => 
                    ...
                    [
                        ...result.map(
                            ({ perusahaan: registerPerusahaan, dokumen }) => ({ type: 'RegisterDokumenIdPerusahaan' as const, id: `${registerPerusahaan?.id}*${dokumen?.id}` })
                        ),
            ...
            getRegisterDokumenByIdPerusahaanAndPage: builder.query<daftarRegisterDokumen, {idPerusahaan: string; page: number; pageSize: number}>({
                ...
                providesTags: (result) => 
                    ...
                    [
                        ...result.map(
                            ({ perusahaan: registerPerusahaan, dokumen }) => ({ type: 'RegisterDokumenIdPerusahaanPage' as const, id: `${registerPerusahaan?.id}*${dokumen?.id}` })
                        ),
            ...
            getRegisterDokumenByDokumen: builder.query<daftarRegisterDokumen, string>({
                ...
                providesTags: (result) => 
                    ...
                    [
                        ...result.map(
                            ({ perusahaan: registerPerusahaan, dokumen }) => ({ type: 'RegisterDokumenNama' as const, id: `${registerPerusahaan?.id}*${dokumen?.id}` })
                        ),
            ...
            getRegisterDokumenByDokumenAndPage: builder.query<daftarRegisterDokumen, {namaDokumen: string; page: number; pageSize: number}>({
                ...
                providesTags: (result) => 
                    ...
                    [
                        ...result.map(
                            ({ perusahaan: registerPerusahaan, dokumen }) => ({ type: 'RegisterDokumenNamaPage' as const, id: `${registerPerusahaan?.id}*${dokumen?.id}` })
                        ),
            ...
            getRegisterDokumenByIdDokumen: builder.query<daftarRegisterDokumen, string>({
                ...
                providesTags: (result) => 
                    ...
                    [
                        ...result.map(
                            ({ perusahaan: registerPerusahaan, dokumen }) => ({ type: 'RegisterDokumenIdDokumen' as const, id: `${registerPerusahaan?.id}*${dokumen?.id}` })
                        ),
            ...
            getRegisterDokumenByIdDokumenAndPage: builder.query<daftarRegisterDokumen, {idDokumen: string; page: number; pageSize: number}>({
                ...
                providesTags: (result) => 
                    ...
                    [
                        ...result.map(
                            ({ perusahaan: registerPerusahaan, dokumen }) => ({ type: 'RegisterDokumenIdDokumenPage' as const, id: `${registerPerusahaan?.id}*${dokumen?.id}` })
                        ),
