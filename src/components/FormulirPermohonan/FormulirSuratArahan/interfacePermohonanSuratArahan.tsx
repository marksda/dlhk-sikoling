...
import { IRegisterPermohonan, IRegisterPermohonanArahan } from "../../../features/permohonan/register-permohonan-api-slice";
...
export interface ISlideSubFormPermohomanSuratArahanParam {  
    ...
    control: Control<IRegisterPermohonanArahan, Object>;
    setValue: UseFormSetValue<IRegisterPermohonanArahan>;
    reset: UseFormReset<IRegisterPermohonanArahan>;
    handleSubmit: UseFormHandleSubmit<IRegisterPermohonanArahan>;
    setError: UseFormSetError<IRegisterPermohonanArahan>;
    setIsLoading: React.Dispatch<React.SetStateAction<boolean>>;
};
export interface ISubFormPermohonanSuratArahanProps {
    control?: Control<any>;
    setValue: UseFormSetValue<IRegisterPermohonanArahan>;
    setMotionKey: React.Dispatch<React.SetStateAction<string>>;
}
