...
type IItemStatusPengurusPermohonan = {key: string|null;} & Partial<IStatusWaliPermohonan>;
...
export const DataListStatusPengurusPermohonanFluentUI: FC<IDataListStatusPengurusPermohonanFluentUIProps> = ({initSelectedFilters, title}) => {   
    ...
    // rtk hook state
    const { data: postsCount, isLoading: isLoadingCount } = useGetJumlahDataStatusWaliPermohonanQuery(queryFilters);
    const { data: postsStatusPengurusPermohonan, isLoading: isLoadingPosts } = useGetDaftarDataStatusWaliPermohonanQuery(queryParams);   
    ...
    const itemsBar: ICommandBarItemProps[] = useMemo(
        ...
        [isSelectedItem, selection, postsStatusPengurusPermohonan]
    );
