...
import { IStatusWali, useGetDaftarStatusWaliPermohonanByFiltersQuery, useGetTotalCountStatusWaliPermohonanQuery } from "../../features/permohonan/status-wali-api-slice";
...
type IItemStatusPengurusPermohonan = {key: string|null;} & Partial<IStatusWali>;
...
export const DataListStatusPengurusPermohonanFluentUI: FC<IDataListStatusPengurusPermohonanFluentUIProps> = ({initSelectedFilters, title}) => {   
    ...
    const [columns, setColumns] = useState<IColumn[]>([    
        { 
            ...
            isSorted: true,
            onRender: (item: IItemStatusPengurusPermohonan) => {
                return item.id;
            }
        },
        { 
    ...
    // rtk hook state
    const { data: postsCount, isLoading: isLoadingCount } = useGetTotalCountStatusWaliPermohonanQuery(queryFilters);
    const { data: postsStatusPengurusPermohonan, isLoading: isLoadingPosts } = useGetDaftarStatusWaliPermohonanByFiltersQuery(queryParams);   
                ...
                <Stack grow verticalFill tokens={stackTokens} className={classNames.container}>
                    <Stack.Item grow className={classNames.gridContainer}>
                        <ScrollablePane scrollbarVisibility="auto">
                            <DetailsList
                                items={
                                    postsStatusPengurusPermohonan != undefined ? postsStatusPengurusPermohonan?.map(
                                        (t) => (
