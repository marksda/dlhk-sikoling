...
import { IPosisiTahapPemberkasan, useGetTotalCountPosisiTahapPemberkasanQuery } from "../../features/permohonan/posisi-tahap-pemberkasan-api-slice";
...
export const DataListPosisiTahapPemberkasanFluentUI: FC<IDataListPosisiTahapPemberkasanFluentUIProps> = ({initSelectedFilters, title}) => {   
    ...
    const { data: postsPosisiTahapPemberkasan, isLoading: isLoadingPosts } = useGetAllModelPerizinanQuery(queryParams);    
