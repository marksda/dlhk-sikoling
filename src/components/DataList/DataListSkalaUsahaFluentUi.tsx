...
import { FormulirSkalaUsaha } from "../Formulir/formulir-skala-usaha";
...
export const DataListSkalaUsahaFluentUI: FC<IDataListSkalaUsahaFluentUIProps> = ({initSelectedFilters, title}) => {   
    ...
    const [dataLama, setDataLama]= useState<ISkalaUsaha|undefined>(undefined);
            ...
            return [
                ...
                { 
                    ...
                    onClick: () => {
                        ...
                        setModeForm('edit');
                        showModalFormulirSkalaUsaha();                        
                        let dataTerpilih = find(postsSkalaUsaha, (i) => i.id == selection.getSelection()[0].key);
    ...
    return (
        <Stack grow verticalFill style={{marginTop: 2}}>
            ...
            {isModalFormulirSkalaUsahaOpen && (
                <FormulirSkalaUsaha
                    title={formulirTitle}
                    isModalOpen={isModalFormulirSkalaUsahaOpen}
                    hideModal={hideModalFormulirSkalaUsaha}
                    mode={modeForm}
                    dataLama={dataLama}
                />
            )}
