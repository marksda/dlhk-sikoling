...
export const FormulirModelPerizinan: FC<IFormulirModelPerizinanFluentUIProps> = ({title, isModalOpen, hideModal, dataLama, mode}) => { 
  // local state
  ...
  //hook-form
  const {handleSubmit, control, resetField, watch} = useForm<IModelPerizinan>({
